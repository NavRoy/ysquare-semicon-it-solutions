...
.hero-content p{font-size:17px;line-height:1.8;color:rgba(255,255,255,.72);max-width:520px;margin-bottom:30px;}
.hero-scroll-btn{
      ...
      <div class="menu-item">
        ...
        <div class="dropdown">
          <div class="dropdown-left">
            <ul>
              <li data-img="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=800&auto=format&fit=crop" data-text="Our Leadership">Leadership</li>
              <li data-img="https://images.unsplash.com/photo-1492724441997-5dc865305da7?w=800&auto=format&fit=crop" data-text="Our Culture">Culture</li>
              <li data-img="https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=800&auto=format&fit=crop" data-text="Global Presence">Global Presence</li>
            </ul>
          </div>
        ...
        <div class="dropdown">
          <div class="dropdown-left">
            <div class="dropdown-group">
              ...
              <ul>
                <li data-img="https://images.unsplash.com/photo-1518770660439-4636190af475?w=800&auto=format&fit=crop" data-text="Digital Engineering">Digital Engineering</li>
                <li data-img="https://images.unsplash.com/photo-1555949963-aa79dcee981c?w=800&auto=format&fit=crop" data-text="Software Engineering">Software Engineering</li>
                <li data-img="https://images.unsplash.com/photo-1581092334651-ddf26d9a09d0?w=800&auto=format&fit=crop" data-text="Embedded Engineering">Embedded Engineering</li>
                <li data-img="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=800&auto=format&fit=crop" data-text="Semiconductor Engineering">Semiconductor Engineering</li>
              </ul>
            </div>
            <div class="dropdown-group">
              <h4>Industries</h4>
              <ul>
                <li data-img="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=800&auto=format&fit=crop" data-text="Hi-Tech">Hi-Tech</li>
                <li data-img="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&auto=format&fit=crop" data-text="Automotive">Automotive</li>
                <li data-img="https://images.unsplash.com/photo-1581090700227-4c4d47a2d1d1?w=800&auto=format&fit=crop" data-text="Semiconductor">Semiconductor</li>
              </ul>
            </div>
          </div>
          <div class="dropdown-right">
...
<div class="mobile-menu" id="mobileMenu">
  <div class="mobile-accordion">
    ...
    <div class="mobile-submenu">
      <a href="#">Leadership</a><a href="#">Culture</a><a href="#">Global Presence</a>
    </div>
  </div>
  <div class="mobile-accordion">
    <button class="mobile-title">What we do <span>+</span></button>
    <div class="mobile-submenu">
      <a href="#">Digital Engineering</a><a href="#">Software Engineering</a>
      <a href="#">Embedded Engineering</a><a href="#">Semiconductor Engineering</a>
      <hr><a href="#">Hi-Tech</a><a href="#">Automotive</a><a href="#">Semiconductor</a>
    </div>
  </div>
  <a href="internship.html">Internships</a>
  <a href="careers.html">Careers</a>
...
<div class="hero-top-strip">
  <a class="hts-back" href="internship.html">
...
<section class="about-hero">
  <img src="https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&w=1800&q=80" alt="YSQUARE Engineering Internship">
  <div class="hero-overlay"></div>
  <div class="hero-glow-a"></div>
  <div class="hero-content">
    <div class="hero-eyebrow">Engineering Careers</div>
    <div class="hero-accent"></div>
    <h1>Apply for<br><span>Engineering</span><br>Internship</h1>
    <p>Start your journey with YSQUARE by working on real engineering projects across Software, Embedded Systems, Semiconductor and Digital Engineering.</p>
...
<nav class="hero-bottom-nav" id="heroBottomNav">
  ...
  <a href="#benefits" class="hbn-link">What You Gain</a>
</nav>
...
<section class="apply-section" id="apply-form">
  ...
  <div class="apply-card reveal" id="applyCard">
    ...
    <div class="apply-card-header">
      <div class="eyebrow" style="justify-content:center;margin-bottom:18px;">Engineering Internship Application</div>
      <h2>Apply Now</h2>
    ...
    <form id="applyForm" method="POST" action="submit.php" enctype="multipart/form-data" novalidate>
      <div class="form-grid">
        ...
        <div class="field">
          ...
          <input type="email" name="email" id="email" placeholder="you@university.edu" autocomplete="email">
        ...
        <div class="field">
          ...
          <input type="text" name="college" id="college" placeholder="e.g. IIT Hyderabad" autocomplete="organization">
          <div class="field-msg" id="msg-college"></div>
        </div>

        <!-- Branch -->
        <div class="field">
          <label>Branch / Department <span>*</span></label>
          <input type="text" name="branch" id="branch" placeholder="e.g. Electronics &amp; Communication">
          <div class="field-msg" id="msg-branch"></div>
        </div>
        ...
        <div class="field">
          ...
          <div class="field-msg" id="msg-gradYear"></div>
        </div>

        <!-- Domain -->
        <div class="field">
          <label>Domain Interested <span>*</span></label>
          ...
          <div class="field-msg" id="msg-domain"></div>
        </div>
        ...
        <!-- Motivation -->
        <div class="field form-full">
          <label>Why would you like to join YSQUARE? <span>*</span></label>
          <textarea name="motivation" id="motivation" placeholder="Tell us what excites you about YSQUARE and how this internship aligns with your engineering goals..." rows="5" maxlength="1000"></textarea>
        ...
        <div class="field form-full">
          <div class="check-row">
            ...
            <label for="certifyCheck">I certify that all information provided is true and accurate. I consent to YSQUARE processing my application data for internship placement purposes in accordance with the <a href="#">Privacy Policy</a>.</label>
          </div>
      ...
      <div class="form-submit">
        ...
        <div class="form-note">Your data is secured with 256-bit encryption and used solely for internship evaluation.</div>
      </div>
    </form>
...
<section class="benefits-section" id="benefits">
  <div class="benefits-header reveal">
    <div class="eyebrow" style="justify-content:center;margin-bottom:18px;">What You Gain</div>
    <h2>Everything Included<br>In Your Internship</h2>
    <p>Every YSQUARE intern receives the same standard of experience — no exceptions, no compromises.</p>
  </div>
  <div class="benefit-cards">
    <div class="benefit-card reveal d1">
      ...
      <p>1:1 guidance from practicing engineers who have shipped products at enterprise scale.</p>
    </div>
    <div class="benefit-card reveal d2">
      ...
      <h4>Live Engineering Projects</h4>
      <p>Contribute to real client-facing deliverables — not classroom simulations or synthetic exercises.</p>
    </div>
    <div class="benefit-card reveal d3">
      ...
      <h4>Certification</h4>
      <p>Formal industry certificate issued on completion, with a documented engineering project portfolio.</p>
    </div>
    <div class="benefit-card reveal d4">
      ...
      <p>Resume preparation, referral pathways and direct placement support into YSQUARE's hiring network.</p>
    </div>
  </div>
</section>
...
<section class="success-section" id="successSection">
  <div class="success-card reveal">
    ...
    <div class="success-ref">
      ...
      Reference ID: <span id="refId">YSQ-2026-0000</span>
    </div>
    ...
    <div class="application-summary">
      ...
      <div class="summary-row"><span>College</span><strong id="sumCollege"></strong></div>
      <div class="summary-row"><span>Domain</span><strong id="sumDomain"></strong></div>
    ...
    <div class="success-actions">
      ...
      <a href="services.html" class="btn-explore">Explore Services</a>
    </div>
  </div>
</section>
...
<div class="footer-col">
    ...
    <div class="footer-col">
      ...
      <p style="font-size:13px;color:rgba(255,255,255,.4);margin-bottom:16px;line-height:1.6;">Engineering solutions start with a conversation.
Reach out to our experts today.</p>
...
/* Field definitions for real-time validation */
const validations = {
  ...
  college:    { test: v => v.trim().length >= 3,       msg: 'Enter your college or university name.' },
  branch:     { test: v => v.trim().length >= 2,       msg: 'Enter your branch or department.' },
  gradYear:   { test: v => v !== '',                   msg: 'Please select your graduation year.' },
  domain:     { test: v => v !== '',                   msg: 'Please select a domain.' },
...
/* Validate single text/select field */
...
/* Attach blur-time validation to each text/select */
...
if(motivationEl){
  motivationEl.addEventListener('input', () => {
    charCountEl.textContent = motivationEl.value.length;
  });
}
...
form.addEventListener('submit', async function(e) {
  ...
  try {
    ...
    if(data.success) {
      ...
      document.getElementById('sumCollege').textContent = data.college;
